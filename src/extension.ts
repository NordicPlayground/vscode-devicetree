        ...
        vscode.TypeDefinitionProvider
{
    ...
    activate(ctx: vscode.ExtensionContext) {
        ...
        ctx.subscriptions.push(
            vscode.commands.registerCommand('devicetree.newApp', commands.newApp),
            vscode.commands.registerCommand('devicetree.save', () => this.saveCtxs(true)),
            vscode.commands.registerCommand('devicetree.ctx.addShield', commands.ctxAddShield),
            vscode.commands.registerCommand('devicetree.ctx.rename', commands.ctxRename),
            vscode.commands.registerCommand('devicetree.ctx.delete', commands.ctxDelete),
            vscode.commands.registerCommand('devicetree.ctx.setBoard', commands.ctxSetBoard),
            vscode.commands.registerCommand('devicetree.getMacro', commands.getMacro),
            vscode.commands.registerCommand('devicetree.edit', commands.edit),
            vscode.commands.registerCommand('devicetree.goto', commands.goTo)
        );
    }
